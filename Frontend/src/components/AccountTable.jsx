            ...
            return (
              <tr key={accountId} className="hover:bg-gray-50 transition">
                ...
                <td className="px-4 py-2 text-right flex gap-2 justify-end items-center">
                  <button className="flex items-center text-xs text-blue-700 hover:underline px-2 py-1" onClick={() => navigate(`/employee/accounts/${accountId}/transactions`)}><EyeIcon />View Transactions</button>
